              ...
              <form>
                ...
                <div class="pl-lg-4" id="detailNext">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3">
                      <div class="form-group">
                        <label class="form-control-label">Thông số màn hình</label>
                        <input
                          class="form-control"
                          type="number"
                          placeholder="VD: 300; 500;..."
                          v-model="product.screen_size"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label">Hệ thống</label>
                        <input
                          class="form-control"
                          type="text"
                          placeholder=""
                          v-model="product.system"
                        />
                      </div>
                    </div>
                    <div class="col-lg-4">
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label"
                          >Độ phân giải (Pixel)</label
                        >
                        <input
                          class="form-control"
                          type="text"
                          placeholder=""
                          v-model="product.resolution"
                        />
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label">Bộ nhớ</label>
                        <input
                          class="form-control"
                          type="text"
                          placeholder=""
...
export default {
  ...
  mounted(){
    this.imageData = store.state.imageData
  }
};
</script>
